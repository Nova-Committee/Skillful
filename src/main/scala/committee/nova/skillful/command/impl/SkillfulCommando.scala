...
//import net.minecraft.util.text.{Style, TextComponentString, TranslationTextComponent, TextFormatting}
...
//      if (!sender.isInstanceOf[ServerPlayerEntity]) return
//      val player = sender.asInstanceOf[ServerPlayerEntity]
//      args.length match {
//        case 0 =>
...
//            }
//            case None => player.sendMessage(new TranslationTextComponent("msg.skillful.skill.notFound")
...
//              case None => sender.sendMessage(new TranslationTextComponent("msg.skillful.skill.notFound")
//                .mergeStyle(TextFormatting.DARK_RED)))
//            }
//            case _ => sender.sendMessage(new TextComponentString(getUsage(sender)))
//          }
//        case None => sender.sendMessage(new TranslationTextComponent("msg.skillful.player.notFound"))
//      }
//    }
//
//    override def getTabCompletions(server: MinecraftServer, sender: ICommandSender, args: Array[String], targetPos: BlockPos): util.List[String] = {
...
//          p.sendMessage(new TranslationTextComponent("msg.skillful.info.cache.clear")
...
//      if (target == null) {
//        sender.sendMessage(new TranslationTextComponent("msg.skillful.player.notFound"))
//        return
//      }
...
//            sender.sendMessage(new TranslationTextComponent("msg.skillful.change.applied")
//              .mergeStyle(TextFormatting.GREEN)))
